...
[**Tout l'enjeu du topic modeling va être de capturer cette intuition dans un cadre mathématique qui permet d'examiner un ensemble de documents et de découvrir, à partir des statistiques sur les mots, quels pourraient être les thèmes et quelle est la proportion de chaque thème dans chaque document.**]{style="color:#4178bc;"}
...
Chacune de ces méthodes s'inspirant de la précédente et venant en corriger une limite.
...
**C'est donc une méthode qui est très utilisé et encore aujourd'hui la mieux implémenté dans R.**
...
## Comment choisir le nombre de topics ? II
